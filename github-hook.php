...
fclose($fp);
echo "<pre>" . `cd /l/mrf8t/var/html/www/; git pull; php composer.phar install; npm i; npm run build` . "</pre>";
system ("cd /l/mrf8t/var/html/www; git pull; php composer.phar install; npm i; npm run build \\;");
