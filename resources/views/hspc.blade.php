...
@section('content')
    ...
    <div>
        <a href="https://docs.google.com/document/d/1nun41JuAuGIfOWPgurogTc4Stgb6uwwXXfQY84RPbHc/edit?usp=sharing" class="btn pt-auto me-3 btn-blue">
            <i class="fa-solid fa-circle-info me-2"></i>
            Information
        </a>
        <a href="https://uvahspc2025.eventbrite.com/" class="btn pt-auto me-3 btn-green">
            <i class="fa-solid fa-user-plus me-2"></i>
            Register
        </a>
        <a href="mailto:hspc@virginia.edu" class="btn pt-auto me-3 btn-red">
        ...
        <div>
            ...
            <div class="rounded border">
                <details class="p-3 border-bottom">
                    <summary>
                        <strong>What are the contest rules?</strong>
                    </summary>
                    <div class="details-container mt-1">
                ...
                <details class="p-3 border-bottom">
                    <summary>
                        <strong>What are the versions of software used?</strong>
                    </summary>
                    <div class="details-container mt-1">
                ...
                <details class="p-3 border-bottom">
                    <summary>
                        <strong>Are there any sample problems available?</strong>
                    </summary>
                    <div class="details-container mt-1">
...
{{--                            <li>{{ past_set.year }} (<a href="{{ past_set.judge_data.url }}">zip</a>) (<a href="{{ past_set.problem_set.url }}">pdf</a>)</li>--}}
{{--                            {% endfor %}--}}
                        </ul>
                    </div>
                </details>
                <details class="p-3 border-bottom">
                    <summary>
                        <strong>What reference materials will be available?</strong>
                    </summary>
                    <div class="details-container mt-1">
                ...
                <details class="p-3 border-bottom">
                    <summary>
                        <strong>What are the prizes like?</strong>
                    </summary>
                    <div class="details-container mt-1">
                ...
                <details class="p-3 border-bottom">
                    <summary>
                        <strong>What are the past results?</strong>
                    </summary>
                    <div class="details-container mt-1">
                ...
                <details class="p-3 border-bottom">
                    <summary>
                        <strong>What is the computer configuration for the contest?</strong>
                    </summary>
                    <div class="details-container mt-1">
                ...
                <details class="p-3 border-bottom">
                    <summary>
                        <strong>Who can I contact if I still have questions?</strong>
                    </summary>
                    <div class="details-container mt-1">
                ...
                <details class="p-3">
                    <summary>
                        <strong>Where do the teams come from?</strong>
                    </summary>
                    <div class="details-container mt-1">
        ...
        <div>
            ...
            <div class="rounded border">
                <details class="p-3 border-bottom">
                    <summary>
                        <strong>Where do I register?</strong>
                    </summary>
                    <div class="details-container mt-1">
                ...
                <details class="p-3 border-bottom">
                    <summary>
                        <strong>What do I need to know about registration?</strong>
                    </summary>
                    <div class="details-container mt-1">
                ...
                <details class="p-3">
                    <summary>
                        <strong>Is financial assistance available?</strong>
                    </summary>
                    <div class="details-container mt-1">
